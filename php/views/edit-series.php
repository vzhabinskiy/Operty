...
<?php if ($project[0]['author'] == true) : ?>
    ...
    <body>
        ...
        <div class="flex">
            ...
            <main class="main-content main-content_project-card">
                <div class="editor-area mb-10">
                    <form id="edit-series" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id" id="id" value="<?= $oneSeries[0]["series_id"] ?>">
                        <div class="editor-area__list mb-3">
                            <div class="editor-area__item mb-2">
                                <div class="editor-area__title">Номер серии</div>
                                <input value="<?= $oneSeries[0]["number"] ?>" class="editor-area__input editor-area__list__number" id="number" name="number" required>
                            </div>
                            <div class="editor-area__item mb-2">
                                <div class="editor-area__title">Название серии</div>
                                <input value="<?= $oneSeries[0]["title"] ?>" class="editor-area__input editor-area__list__title" id="title" name="title" required>
                            </div>
                        </div>
                        <textarea class="" id="text" name="text" placeholder="Напишите что-нибудь">
                        <?= $oneSeries[0]["text"] ?>
                    </textarea>
                        <button type="submit" class="button-editor">Сохранить</button>
                    </form>
                </div>
            </main>
        </div>
        ...
        <script src="../../source/js/seriesRequests.js"></script>
    </body>
